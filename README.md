...
- [locative] **INCLUDE** *SOURCE &KEY LINE-PREFIX HEADER FOOTER HEADER-NL FOOTER-NL*
    ...
    In the above example, pressing `M-.` on [`PAX.EL`][d5c6] will open the
    ...
    When documentation is generated, the entire [`pax.el`][d5c6] file is
...
- Separate markup parsing and result rendering code to support markups other than Markdown and HTML.
  ...
  [d5c6]: #x-2840ANTS-DOC-2FDOC-3A-3APAX-2EEL-20-2840ANTS-DOC-2FLOCATIVES-3AINCLUDE-20-23P-22-2Fhome-2Frunner-2Fwork-2Fdoc-2Fdoc-2Felisp-2Fpax-2Eel-22-20-3AHEADER-NL-20-22-60-60-60elisp-22-20-3AFOOTER-NL-20-22-60-60-60-22-29-29 "(40ANTS-DOC/DOC::PAX.EL (40ANTS-DOC/LOCATIVES:INCLUDE #P\"/home/runner/work/doc/doc/elisp/pax.el\" :HEADER-NL \"```elisp\" :FOOTER-NL \"```\"))"
