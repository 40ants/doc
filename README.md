...
<a id='x-2840ANTS-DOC-2FDOC-3A-3APAX-2EEL-20-2840ANTS-DOC-2FLOCATIVES-3AINCLUDE-20-23P-22-2FUsers-2Fart-2Fprojects-2Flisp-2F40ants-doc-2F-2Eqlot-2Fdists-2Fquicklisp-2Fsoftware-2Fmgl-pax-20210124-git-2Fsrc-2Fpax-2Eel-22-20-3AHEADER-NL-20-22-60-60-60elisp-22-20-3AFOOTER-NL-20-22-60-60-60-22-29-29'></a>
...
- [macro] **DEFSECTION** *NAME (&KEY (PACKAGE-SYMBOL '\*PACKAGE\*) (READTABLE-SYMBOL '\*READTABLE\*) (EXPORT T) TITLE LINK-TITLE-TO (DISCARD-DOCUMENTATION-P 40ANTS-DOC::\*DISCARD-DOCUMENTATION-P\*)) &BODY ENTRIES*
    ...
    (OBJECT [`LOCATIVE`][2d83]) pair or `NIL`, to which the heading will link when
...
- [variable] **40ANTS-DOC/LINK::\*DOCUMENT-LINK-CODE\*** *T*
    ...
    This situation occurs in PAX with [`SECTION`][ba26] which is both a class (see
    [SECTION][class]) and a locative type denoted by a symbol (see
    [`SECTION`][ba26]). Back in the example above, clearly,
...
- [locative] **SECTION**
    ...
    Refers to a section defined by [`DEFSECTION`][79c1].
...
- [locative] **ARGUMENT**
    ...
    An alias for [`DISLOCATED`][69c0], so the one can refer to an argument of a
...
- [locative] **INCLUDE** *SOURCE &KEY LINE-PREFIX HEADER FOOTER HEADER-NL FOOTER-NL*
    ...
    In the above example, pressing `M-.` on [`PAX.EL`][8e3b] will open the
    ...
    When documentation is generated, the entire [`pax.el`][8e3b] file is
...
- [macro] **40ANTS-DOC/GLOSSARY::DEFINE-GLOSSARY-TERM** *NAME (&KEY TITLE (DISCARD-DOCUMENTATION-P 40ANTS-DOC::\*DISCARD-DOCUMENTATION-P\*)) DOCSTRING*
    ...
    is a bit like a [`SECTION`][ba26] in that, when linked to, its TITLE will be
...
- [function] **40ANTS-DOC/LOCATIVES/BASE::LOCATE** *OBJECT LOCATIVE &KEY (ERRORP T)*
    ...
    Follow [`LOCATIVE`][2d83] from OBJECT and return the object it leads to or a
...
- [function] **40ANTS-DOC/LOCATIVES/BASE::LOCATIVE-TYPE** *LOCATIVE*
    ...
    The first element of [`LOCATIVE`][2d83] if it's a list. If it's a symbol then
...
- [function] **40ANTS-DOC/LOCATIVES/BASE::LOCATIVE-ARGS** *LOCATIVE*
    ...
    The `REST` of [`LOCATIVE`][2d83] if it's a list. If it's a symbol then
    it's ().
...
- [macro] **40ANTS-DOC/LOCATIVES/BASE::DEFINE-LOCATIVE-TYPE** *LOCATIVE-TYPE LAMBDA-LIST &BODY DOCSTRING*
    ...
    Declare LOCATIVE-TYPE as a [`LOCATIVE`][2d83]. One gets two
...
- [class] **40ANTS-DOC:SECTION**
    ...
    [`DEFSECTION`][79c1] stores its NAME, TITLE, [`PACKAGE`][dc19],
...
<a id='x-2840ANTS-DOC-2FTRANSCRIBE-3A-3ATRANSCRIBE-2EEL-20-2840ANTS-DOC-2FLOCATIVES-3AINCLUDE-20-23P-22-2FUsers-2Fart-2Fprojects-2Flisp-2F40ants-doc-2Felisp-2Ftranscribe-2Eel-22-20-3AHEADER-NL-20-22-60-60-60elisp-22-20-3AFOOTER-NL-20-22-60-60-60-22-29-29'></a>
...
- [condition] **TRANSCRIPTION-VALUES-CONSISTENCY-ERROR** *TRANSCRIPTION-CONSISTENCY-ERROR*
  ...
  [8e3b]: #x-2840ANTS-DOC-2FDOC-3A-3APAX-2EEL-20-2840ANTS-DOC-2FLOCATIVES-3AINCLUDE-20-23P-22-2FUsers-2Fart-2Fprojects-2Flisp-2F40ants-doc-2F-2Eqlot-2Fdists-2Fquicklisp-2Fsoftware-2Fmgl-pax-20210124-git-2Fsrc-2Fpax-2Eel-22-20-3AHEADER-NL-20-22-60-60-60elisp-22-20-3AFOOTER-NL-20-22-60-60-60-22-29-29 "(40ANTS-DOC/DOC::PAX.EL (40ANTS-DOC/LOCATIVES:INCLUDE #P\"/Users/art/projects/lisp/40ants-doc/.qlot/dists/quicklisp/software/mgl-pax-20210124-git/src/pax.el\" :HEADER-NL \"```elisp\" :FOOTER-NL \"```\"))"
