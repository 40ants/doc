...
## [method](95c8) `common-lisp:print-object` (object foo-random-state) stream

<a id="x-28FOO-RANDOM-3A-2AFOO-STATE-2A-20-28VARIABLE-29-29"></a>

## [variable](7d65) `foo-random:*foo-state*` #<foo-random-state >

Much like `*RANDOM-STATE*` but uses the `FOO` algorithm.

<a id="x-28FOO-RANDOM-3AGAUSSIAN-RANDOM-20FUNCTION-29"></a>

## [function](f057) `foo-random:gaussian-random` stddev &key (random-state \*foo-state\*)
...
## [function](ddc9) `foo-random:uniform-random` limit &key (random-state \*foo-state\*)
...
[c6a8]: https://github.com/40ants/doc/blob/40084122556e4d9b1b60be69ef2a3672a32c3349/tutorial.lisp#L34
[8e5a]: https://github.com/40ants/doc/blob/40084122556e4d9b1b60be69ef2a3672a32c3349/tutorial.lisp#L35
[95c8]: https://github.com/40ants/doc/blob/40084122556e4d9b1b60be69ef2a3672a32c3349/tutorial.lisp#L38
[7d65]: https://github.com/40ants/doc/blob/40084122556e4d9b1b60be69ef2a3672a32c3349/tutorial.lisp#L41
[ddc9]: https://github.com/40ants/doc/blob/40084122556e4d9b1b60be69ef2a3672a32c3349/tutorial.lisp#L44
[f057]: https://github.com/40ants/doc/blob/40084122556e4d9b1b60be69ef2a3672a32c3349/tutorial.lisp#L50
````
