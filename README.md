...
## [method](c698) `common-lisp:print-object` (object foo-random-state) stream

<a id="x-28FOO-RANDOM-3A-2AFOO-STATE-2A-20-28VARIABLE-29-29"></a>

## [variable](deac) `foo-random:*foo-state*` #<foo-random-state >

Much like `*RANDOM-STATE*` but uses the `FOO` algorithm.

<a id="x-28FOO-RANDOM-3AGAUSSIAN-RANDOM-20FUNCTION-29"></a>

## [function](8800) `foo-random:gaussian-random` stddev &key (random-state \*foo-state\*)
...
## [function](64a9) `foo-random:uniform-random` limit &key (random-state \*foo-state\*)
...
[2740]: https://github.com/40ants/doc/blob/828db9ea88b54f8423d0f33706b10ae109854003/full/tutorial.lisp#L35
[da48]: https://github.com/40ants/doc/blob/828db9ea88b54f8423d0f33706b10ae109854003/full/tutorial.lisp#L36
[c698]: https://github.com/40ants/doc/blob/828db9ea88b54f8423d0f33706b10ae109854003/full/tutorial.lisp#L39
[deac]: https://github.com/40ants/doc/blob/828db9ea88b54f8423d0f33706b10ae109854003/full/tutorial.lisp#L42
[64a9]: https://github.com/40ants/doc/blob/828db9ea88b54f8423d0f33706b10ae109854003/full/tutorial.lisp#L45
[8800]: https://github.com/40ants/doc/blob/828db9ea88b54f8423d0f33706b10ae109854003/full/tutorial.lisp#L51
````
