...
## [method](0ce1) `common-lisp:print-object` (object foo-random-state) stream

<a id="x-28FOO-RANDOM-3A-2AFOO-STATE-2A-20-28VARIABLE-29-29"></a>

## [variable](fd51) `foo-random:*foo-state*` #<foo-random-state >

Much like `*RANDOM-STATE*` but uses the `FOO` algorithm.

<a id="x-28FOO-RANDOM-3AGAUSSIAN-RANDOM-20FUNCTION-29"></a>

## [function](07d8) `foo-random:gaussian-random` stddev &key (random-state \*foo-state\*)
...
## [function](73fb) `foo-random:uniform-random` limit &key (random-state \*foo-state\*)
...
[a6c2]: https://github.com/40ants/doc/blob/1ea006a0ac4fac0afd994658a2f362fbb069bcac/tutorial.lisp#L34
[84d1]: https://github.com/40ants/doc/blob/1ea006a0ac4fac0afd994658a2f362fbb069bcac/tutorial.lisp#L35
[0ce1]: https://github.com/40ants/doc/blob/1ea006a0ac4fac0afd994658a2f362fbb069bcac/tutorial.lisp#L38
[fd51]: https://github.com/40ants/doc/blob/1ea006a0ac4fac0afd994658a2f362fbb069bcac/tutorial.lisp#L41
[73fb]: https://github.com/40ants/doc/blob/1ea006a0ac4fac0afd994658a2f362fbb069bcac/tutorial.lisp#L44
[07d8]: https://github.com/40ants/doc/blob/1ea006a0ac4fac0afd994658a2f362fbb069bcac/tutorial.lisp#L50
````
